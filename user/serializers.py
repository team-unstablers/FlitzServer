...
class UserRegistrationCompletePhoneVerificationSerializer(serializers.Serializer):
    verification_code = serializers.CharField(required=True, allow_null=True, allow_blank=True)

    encrypted_payload = serializers.CharField(required=True, allow_null=True, allow_blank=True)
    payload_hmac = serializers.CharField(required=True, allow_null=True, allow_blank=True)

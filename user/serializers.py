...
class UserRegistrationCompletePhoneVerificationSerializer(serializers.Serializer):
    verification_code = serializers.CharField(required=False, allow_null=True, allow_blank=False)

    encrypted_payload = serializers.CharField(required=False, allow_null=True, allow_blank=False)
    payload_hmac = serializers.CharField(required=False, allow_null=True, allow_blank=False)

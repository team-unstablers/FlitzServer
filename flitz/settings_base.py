...
TURNSTILE_SECRET_KEY = os.environ.get('FLITZ_TURNSTILE_SECRET_KEY')
...
ALIGO_USER_ID='teamunstablers'
ALIGO_API_KEY=os.environ.get('FLITZ_ALIGO_API_KEY')
ALIGO_SENDER_NUMBER=os.environ.get('FLITZ_ALIGO_SENDER_NUMBER')